...
export const LOADING_MESSAGES = [
  ...
  "Just a sec! We're on it... 🚀",
  "Hang in there! Good things are coming... ⏱️",
  "Almost there! We're putting on the finishing touches... 🎨",
  "One moment, please! We're getting everything set... 🔄",
  "Hold tight! We're working our magic... ✨",
  "Just a moment! We're making sure everything's perfect... 🛠️",
  "We're nearly there! Stay with us... 📦",
  "Give us a second! We're making it happen... ⚡",
  "Patience, please! We're bringing it all together... 🧩",
  "Good things take time—hang tight! ⏲️",
  "We're on it! Just a moment... 🔧",
  "A little patience, and we'll be all set... 🍀",
  "Loading... we're almost ready! 🌐",
  "Hold on! We're setting things up... 🛠",
  "We're brewing something good... ☕",
  "Just a bit longer! We're fine-tuning things... 🎛️",
  "Almost done! We're wrapping things up... 🎁",
  "Stay with us! We're making sure everything's perfect... 🔍",
  "One sec! We're pulling it all together... 🤹",
  "Getting things ready—just a moment! ⏱️",
  "We’re on it! Hang tight... 🧠",
  "Nearly there! We appreciate your patience... 🌈",
  "Give us a moment! We're doing the heavy lifting... 🏗️",
  "We're putting the pieces together... 🧩",
  "Just a few seconds more! We're almost set... 🎯",
  "Thank you for waiting! We're almost there... 💡",
  "Hang tight! We're putting on the final touches... 🎨",
  "A little patience goes a long way—just a moment! 🕰️",
  "We're almost ready! Thanks for hanging in there... 🌟",
];
